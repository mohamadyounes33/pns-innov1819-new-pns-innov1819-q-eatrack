...
class frigo_test(unittest.TestCase):
	...
	def setUp(self):
		...
		self.recipe_to_complete_ingredients = ['fraise', 'banane', 'yaourt', 'chocolat']
		self.missing_ingedients = ['yaourt', 'chocolat']
	...
	def test_get_missing_ingredients(self):
		"""Test fonction to get missing ingredients to complete a recipe"""
		missing_ingredient = tools.get_ingredients_to_buy(self.recipe_to_complete_ingredients, self.frigo_content_depart)
		self.assertEqual(self.missing_ingedients, missing_ingredient)
